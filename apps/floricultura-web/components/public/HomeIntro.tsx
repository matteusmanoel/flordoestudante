...
export function HomeIntro() {
  return (
    <section id="sobre" className="border-b border-border/60 bg-gradient-to-b from-background via-green-50/30 to-emerald-50/40 py-16 sm:py-24">
      <div className="container px-4">
        <AnimatedSection className="mx-auto max-w-2xl text-center" delay={0.1}>
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed">
            ...
            na loja ou entrega, e pode enviar uma mensagem no cartão. Tudo simples e
            seguro, com pagamento online ou na hora.
          </p>
        </AnimatedSection>
      </div>
    </section>
